...
if (isset($_POST["submit"])) {
    $_nama = $_POST['nama'];
    $_kelurahan_id = $_POST['kec.id']; // Change 'kelurahan' to 'kelurahan_id'
    $data = [$_nama, $_kelurahan_id];
    $sql = "INSERT INTO kelurahan (nama, kec.id) VALUES (?, ?)"; // Change 'kelurahan' to 'kelurahan_id'
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        $rsjenis = $dbh->query($sqljenis);
                                        ?>
                                        <select id="kec.id" name="kec.id" class="custom-select">
                                            <?php
                                            foreach ($rsjenis as $rowjenis) {
                                            ?>
                                                <option value="<?= $rowjenis['id'] ?>"><?= $rowjenis['kec.id'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
